namespace Microsoft.Xna.Framework.Data
{
	public class DataLoaderConfig
	{
		...
		public bool StatesHack { get; set; }
		...
		public static DataLoaderConfig Decorate(IncludeDelegate includeDelegate)
		{
			return new DataLoaderConfig
			{
				SemicolonEndsKeyValuePair = false,
				...
				UseSubnodes = true,
				UseSections = false,
				EqualsSignMarksEquality = false,
				ColonMarksEquality = false,
				NewlineEndsKeyValuePairEvenIfValueIsEmpty = false,
				UseCSingleLineComments = true,
				UseCMultiLineComments = true,
				SpaceMarksEquality = true,
				AllowFlags = true,
				StatesHack = true,
				PreprocessorInclude = includeDelegate,
				IncludeQuotationMarks = true,
		...
		public static DataLoaderConfig ZScript(IncludeDelegate includeDelegate)
		{
			return new DataLoaderConfig
			{
				SemicolonEndsKeyValuePair = true,
		...
		public static DataLoaderConfig ParadoxFormat()
		{
			return new DataLoaderConfig
			{
				SemicolonEndsKeyValuePair = false,
				SemicolonStartsComment = false,
				HashtagStartsComment = true,
				NewlineEndsKeyValuePair = true,
				UseSubnodes = true,
				UseSections = false,
				EqualsSignMarksEquality = true,
